...
const Pagination=({pages,setCurrentPage})=>{
    ...
    for(let i=1; i<=pages; i++){
        employeepages.push(i)
    }
    // console.log(employeepages)
    ...
    return(
        <div className="clearfix">
				...
				<ul className="pagination">
					...
					<li className={currentButton===employeepages.length ? "page-item disabled" : "page-item"}><a href="#!" className="page-link"
                    onClick={()=>setCurrentButton((next)=> next === employeepages.length ? next : next+1)}
                    >Next</a></li>
				</ul>
			</div>
    )
